...
\begin{document}
	...
	Para alcanzar el objetivo propuesto en esta investigación, es necesario identificar las menciones a la ciencia presentes en un texto. Para ello, se desarrolló una estrategia derivada de la búsqueda semántica, la cual es un método de recuperación de información. La búsqueda semántica permite recuperar resultados o documentos basándose en la similitud semántica sin que haya superposición de palabras clave \cite{Wei2022}. Para lograrlo, combina embeddings, que son representaciones vectoriales de los textos que preservan su significado y contexto, con métodos para medir la similitud semántica, como la similitud de coseno. \\
	...
	Para este proyecto se decidió usar un modelo de embeddings preentrenado, esto quiere decir que es un modelo que fue creado y entrenado previamente con un gran volumen de datos y por tanto puede aprovecharse en otro conjuntos de datos diferente, haciendo posible analizar data sin crear un modelo de cero. [BUSCAR CITA]
