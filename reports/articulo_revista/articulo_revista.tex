...
\begin{document}
	...
	A partir de este contexto, la presente investigación busca responder la siguiente pregunta: ¿con qué temas, organizaciones, actores y eventos se asocia la ciencia en las columnas de opinión en Colombia, y qué patrones discursivos emergen de estas asociaciones?
	
	Para ello, este artículo propone una estrategia basada en procesamiento de lenguaje natural que permite identificar menciones a la ciencia en columnas de opinión y luego encontrar distintos elementos en el discurso, como las entidades o determinado vocabulario, con el fin de comprender cómo la ciencia es representada en el contexto colombiano.
	...
	El proceso realizado se describe en el diagrama de flujo de la Figura \ref{fig:diagramaflujo}.
